...
- 📖 Explore two main topics:

1. Retrieval Augmented Generation (RAG)
2. Building a chatbot

- 🤗 LangChain provides the potential of Large Language Models (LLMs) to retrieve contextual documents and create chatbots that respond using your own data.
